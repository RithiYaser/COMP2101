...
function interrupt {
    sleepCount=10
    echo "You cannot interrupt this process. Resetting to 10"
...
#THis function resets the timer to 100% and counts down


function quit1 {
    echo "You found the way out"
    exit 1
}

#This function exits from the script immediately.
...
#Catches the signals and runs the function associated with it.
