...
#This command tests if /tmp is readable
[ -w /tmp ] && echo "/tmp is writable" || echo "/tmp is not writable"
#This command tests if it is writable
[ -x /tmp ] && echo "/tmp is accessible and can be executed" || echo "/tmp is not executable"
#This command checks if the directory is executable
...
echo "Enter a number"
read firstNumber
#Asks the user to enter a number and the value is assigned to firstNumber
echo "Enter another number"
read secondNumber
#Asks the user to enter another number and the value is assigned to secondNumber
